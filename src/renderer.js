...
function renderPage() {
  ...
  let html = '';
  if (page === 'settings') html += automationSettingsHTML();
  ...
  if (page === 'settings') bindAutomationSettings();
